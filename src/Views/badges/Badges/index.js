...
export default class Badges extends React.Component {
  ...
  render() {
    ...
    return (
      <Col xs="12" className={cn(align.full, align.noMarginPad, align.vCenter)}>
        <Row className={cn(align.full, align.noMarginPad, align.allCenter)}>
          <Col
            xs="12"
            className={cn(align.topCenter, align.noMarginPad, "yourbadges")}
          >
            <p className={cn("yourbadges")}>Click on a Badge to get access.</p>
          </Col>
